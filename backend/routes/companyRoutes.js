...
const { getDashboard, getOngoingProjects, getProjectRequests, updateProjectStatusController, 
    ...
    createHireRequest, updateCompanyProfile, handleWorkerRequest, submitBidController, submitProjectProposal, getEmployees, updatePassword} = require('../controllers/companyController');
